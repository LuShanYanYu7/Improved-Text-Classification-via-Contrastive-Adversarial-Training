...
dict_path = './bert-base-uncased/vocab.txt'
...
train_data = load_data(
    './data/GLUE/MRPC/msr_paraphrase_train.txt'
)
valid_data = load_data(
    './data/GLUE/MRPC/msr_paraphrase_test.txt'
)
...
if __name__ == '__main__':
    ...
    # 预测测试集，输出到结果文件
    test_predict(
        in_file='./data/GLUE/MRPC/test.tsv',
        out_file='./results/GLUE/MRPC.tsv'
    )
